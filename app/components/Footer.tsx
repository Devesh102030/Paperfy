            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-9 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                    ...
                    <div className="lg:col-span-2 lg:text-left text-center">
                        <h4 className="text-lg text-gray-900 font-medium mb-7">Peperfy</h4>
                    ...
                    <div className="lg:col-span-2 lg:text-left text-center">
                        ...
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="javascript:;"  className="text-gray-600 hover:text-gray-900">How It Works</a></li>
                            <li className="mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">AI Overview Generator</a></li>
                            <li className="mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">PDF Chat Assistant</a></li>
                            <li><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">Upload & Manage Papers</a></li>
                        </ul>
                    </div>
